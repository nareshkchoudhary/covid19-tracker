        ...
        action.setCallback(this,response=>{
            ...
            if(state==="SUCCESS"||state=="DRAFT"){
               ...
               // console.log(JSON.stringify(res));
                ...
                var endRecord=totalRecords>=(pageNumber*pageSize)?(pageNumber*pageSize):totalRecords;
                var totalPages=Math.ceil(totalRecords/pageSize);
                console.log("start:"+startRecord+",end:"+endRecord);
                //for country specific
                var dataArray=[];
                for(var i=startRecord;i<endRecord;i++){
                    if(query==="byCountry" && countryName!='' && res.countries[i].Country.toLowerCase().includes(countryName.toLowerCase())){
                         var data={
                        id:i,
